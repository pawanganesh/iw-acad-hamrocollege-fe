...
class Requestform extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { user, book, request_date } = this.state;
    const requests = { user, book, request_date };
  ...
  render() {
    const { book, request_date } = this.state;
    return (
...
export default connect(mapStateToProps, { addRequests, getBooks })(Requestform);
